...
const TCHAR _WndPropName_MenuXP[] = _T("HPWndProp_MenuXP");
...
CMenuItem::CMenuItem (HMENU hMenu, UINT uItem, bool fByPosition)
{
    ...
    if ( !(m_miInfo.fType & MFT_SEPARATOR) )
    {
        if ( m_miInfo.hSubMenu != NULL )
        {
           ...
           // CMenuXP::ms_SubMenuImages.Lookup (m_miInfo.hSubMenu, m_ImgDesc); //zxy  modified....
        }
        else
        {
...
// 9 Jul 2003 begin mods Kris Wojtas
///////////////////////////////////////////////////////////////////////////////
	static BOOL bGradient=AfxGetApp()->GetProfileInt("MenuXP", "ShowGradient", TRUE);
...
///////////////////////////////////////////////////////////////////////////////
void  CMenuXP::ClearMenuItemImage()
{
	ms_Images.RemoveAll();
}
///////////////////////////////////////////////////////////////////////////////
...
bool CMenuXP::OnDrawItem (DRAWITEMSTRUCT* pDrawItemStruct, HWND hWnd)
{
    ...
    CMenuItem item ((HMENU)pDrawItemStruct->hwndItem, pDrawItemStruct->itemID, false);//find toolbar icon ...and ....
    CFontDC font (cDC, DEFAULT_GUI_FONT);
...
void CWndMenuXP::OnPrint (CDC* pDC, bool bOwnerDrawnItems)
{
    ...
    if ( GetWinVersion() < wvWinXP )
    {
        ...
        CDC CW2CMemDC;
        CW2CMemDC.CreateCompatibleDC (pDC);
        HGDIOBJ hOldBitmap = ::SelectObject (CW2CMemDC.m_hDC, m_bmpBkGnd);
        pDC->BitBlt (0, rc.bottom-SM_CXSHADOW, SM_CXSHADOW*2, SM_CXSHADOW, &CW2CMemDC, 0, rc.bottom-SM_CXSHADOW, SRCCOPY);
        pDC->BitBlt (rc.right-SM_CXSHADOW, rc.bottom-SM_CXSHADOW, SM_CXSHADOW, SM_CXSHADOW, &CW2CMemDC, rc.right-SM_CXSHADOW, rc.bottom-SM_CXSHADOW, SRCCOPY);
        pDC->BitBlt (rc.right-SM_CXSHADOW, 0, SM_CXSHADOW, SM_CXSHADOW*2, &CW2CMemDC, rc.right-SM_CXSHADOW, 0, SRCCOPY);
        DrawShadow (CW2CMemDC.m_hDC, pDC->m_hDC, rc);
        ::SelectObject (CW2CMemDC.m_hDC, hOldBitmap);
    }
}
